                            ...
                            {!renderMode && onUpdateParcelas && (
                              <div className="flex items-center gap-1 print:hidden">
                                <select
                                  ...
                                  className="text-[10px] px-1 py-0.5 bg-blue-50 border border-blue-300 rounded text-blue-700 cursor-pointer focus:outline-none"
                                  defaultValue=""
                                >
                                ...
                                <button
                                  type="button"
                                  onClick={() => addParcela()}
                                  className="text-[10px] px-1.5 py-0.5 bg-emerald-50 hover:bg-emerald-100 border border-emerald-300 rounded text-emerald-700 font-bold"
                            ...
                            <table className="w-full text-[10px] border-collapse mt-0.5">
                              <thead>
                                <tr className="bg-gray-100 border-b-2 border-gray-700">
                                  <th className="text-left py-1.5 px-2 font-bold text-gray-700 uppercase tracking-wider text-[9px]">Data</th>
                                  <th className="text-left py-1.5 px-2 font-bold text-gray-700 uppercase tracking-wider text-[9px]">Método</th>
                                  <th className="text-right py-1.5 px-2 font-bold text-gray-700 uppercase tracking-wider text-[9px]">Valor</th>
                              ...
                              <tbody>
                                      ...
                                      {!renderMode && onUpdateParcelas ? (
                                        <div className="flex items-center gap-1">
                                          <select
                                            ...
                                            className="text-[10px] px-1 py-0.5 bg-white border border-gray-300 rounded"
                                          >
                                          ...
                                          {p.dataTipo === 'apos_nf' && (
                                            <input
                                              ...
                                              className="w-12 text-[10px] px-1 py-0.5 bg-white border border-gray-300 rounded text-center"
                                            />
                                          )}
                                          {p.dataTipo === 'data_fixa' && (
                                            <input
                                              ...
                                              className="w-20 text-[10px] px-1 py-0.5 bg-white border border-gray-300 rounded"
                                            />
                                          )}
                                        </div>
                                      ) : (
                                      ...
                                      {!renderMode && onUpdateParcelas ? (
                                        <div className="flex items-center justify-end gap-0.5">
                                          <input
                                            ...
                                            placeholder="%"
                                            className="w-14 text-[10px] px-1 py-0.5 bg-white border border-gray-300 rounded text-right"
                                          />
                                    ...
                                    {!renderMode && onUpdateParcelas && (
                                      <td className="py-1 px-1 text-center print:hidden">
                                        <button
                                          ...
                                          className="text-red-500 hover:text-red-700 text-[14px] leading-none"
                                          title="Remover"
                                        >×</button>
                                      </td>
                                    )}
                                ...
                                <tr className="border-t-2 border-gray-700 font-bold bg-gray-50">
                                  <td className="py-1.5 px-2 uppercase text-[9px] tracking-wider" colSpan={2}>Total</td>
                                  <td className="py-1.5 px-2 text-right">
                                    <span className={`text-[9px] mr-2 ${Math.abs(totalPct - 100) < 0.5 ? 'text-emerald-700' : 'text-amber-700'}`}>
                                      {totalPct.toFixed(2)}%
                                    </span>
