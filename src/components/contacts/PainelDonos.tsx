...
import type { MeuPlacar, RelatorioContatos, Violacao } from '@/hooks/useMeusContatos'
    ...
    <section aria-label="Donos dos contatos" className="mt-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-1.5">
        ...
        <Numero
          ...
          ajuda="Sem vendedor E sem orçamento nenhum: o bolsão que pode ser prospectado à vontade. Clique para filtrar a lista por ele."
        />
        <Numero
