...
import { brl, dataBR, numero } from '@/lib/precificacao-racao/formato'
import { linkWhatsApp, resumoTexto, textoWhatsApp, type DadosProposta } from '@/lib/precificacao-racao/proposta'
