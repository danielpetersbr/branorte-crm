...
import { ESPECIES, STATUS_PROPOSTA } from '@/lib/precificacao-racao/catalogo'
import { brl, dataBR, numero, pct } from '@/lib/precificacao-racao/formato'
import type { Especie, SimulacaoRow, StatusProposta } from '@/lib/precificacao-racao/tipos'
import type { FiltrosSimulacao } from '@/hooks/usePrecificacaoRacao'
