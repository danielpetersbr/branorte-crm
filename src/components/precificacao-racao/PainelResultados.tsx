...
import { brl, brlKg, kg, numero, pct, toneladas } from '@/lib/precificacao-racao/formato'
import type { ResultadoSimulacao, SimulacaoInput } from '@/lib/precificacao-racao/tipos'
