...
export function OrcamentoBuilder() {
  ...
  useEffect(() => {
    if (modeloSelecionado && modeloSelecionado.id !== lastModeloIdRef.current) {
      // Compacta 02/03 ja vem com Balança Eletronica nos itens (R$ 8.728)
      // populada direto no banco. Aqui apenas copia o modelo.
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-baseline justify-between gap-2 text-[11px]">
                      ...
                      <span className="font-bold text-success tabular-nums">{formatBRL(Number(m.total_proposta))}</span>
                    </div>
