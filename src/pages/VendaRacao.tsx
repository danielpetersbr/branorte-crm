...
import { calcularSimulacao } from '@/lib/venda-racao/calculo'
import { novaSimulacao, normalizarInput, trocarEspecie } from '@/lib/venda-racao/estado'
import { dadosProposta } from '@/lib/venda-racao/proposta'
import { brl, hojeISO } from '@/lib/venda-racao/formato'
import { supabase } from '@/lib/supabase'
import type { Especie, SimulacaoInput, SimulacaoRow, StatusProposta } from '@/lib/venda-racao/tipos'
import { CONFIG_PADRAO, STATUS_PROPOSTA } from '@/lib/venda-racao/catalogo'
import { FormularioVendaRacao } from '@/components/venda-racao/FormularioVendaRacao'
import { PainelResultados } from '@/components/venda-racao/PainelResultados'
import { PropostaCliente } from '@/components/venda-racao/PropostaCliente'
import { HistoricoSimulacoes } from '@/components/venda-racao/HistoricoSimulacoes'
import { ConfiguracoesVendaRacao } from '@/components/venda-racao/ConfiguracoesVendaRacao'
