// dispatch-test: NEUTRALIZADO em 2026-05-15.
// Era disparo de teste via extensao do vendedor. Descontinuado.
...
Deno.serve(async (req: Request) => {
  ...
  console.log('[disparo-desativado:dispatch-test]', req.method, 'ua:', req.headers.get('user-agent') ?? '?')
